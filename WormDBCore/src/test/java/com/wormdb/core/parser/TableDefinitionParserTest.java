...
public class TableDefinitionParserTest 
{
	...
	public void testSimpleParse() 
	{
		...
		TableDefinition tableDef = 
				TableDefinitionParser.parseTableDefinitionFromJSONFile(rootDir + "/src/test/resources/ParserTests/TableDefinitionParserTestFiles/tableDefinitionTestCase1.json");
